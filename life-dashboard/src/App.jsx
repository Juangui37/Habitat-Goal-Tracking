...
// ─── SEED GOALS (14 total) ───────────────────────────────────────────────────
const SEED_GOALS = [
  { id:"g1", category:"physical", priority:"High", title:"Gain 10-15 lbs of lean muscle & hit strength PRs", specific:"Gain 10–15 lbs of lean muscle bringing bodyweight to 150–155 lbs, hit a 225 lb hang clean and 315 lb squat, with visible improvements in shoulder size and glute development.", measurable:"Weekly weigh-ins via MyFitPal scale. Log all lifts in training journal. PRs are pass/fail. Progress photos every 4 weeks.", achievable:"Currently ~140–145 lbs, 185 hang clean, prior 315 squat at 145 lbs. On 17-week Runna plan + 5-day gym schedule + creatine + meal prep.", relevant:"You've conquered endurance — sub-3hr marathon and Half Ironman. Muscle is the next frontier.", timebound:"2026-09-01", subtasks:[{id:"g1s1",label:"Reach 148 lbs bodyweight",done:false},{id:"g1s2",label:"Hit 205 lb hang clean",done:false},{id:"g1s3",label:"Hit 225 lb hang clean PR",done:false},{id:"g1s4",label:"Hit 275 lb squat",done:false},{id:"g1s5",label:"Hit 315 lb squat",done:false},{id:"g1s6",label:"Reach 150–155 lbs bodyweight",done:false},{id:"g1s7",label:"Take 4-week progress photo comparison",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g2", category:"physical", priority:"High", title:"Run a half marathon in 1:25 or faster while building muscle", specific:"Complete a half marathon in sub-1:25 while simultaneously gaining lean muscle mass — proving that strength and speed gains are not mutually exclusive.", measurable:"Time tracked via Garmin or running app. Half marathon race registered and completed. Current baseline to be established in a time trial.", achievable:"Already following a 17-week Runna plan with 4 runs/week. Sub-2:58 marathon proves elite aerobic base. This is a speed + efficiency goal, not a volume increase.", relevant:"You want to be the complete athletic machine — fast, strong, and built. This proves you can do both at once.", timebound:"2026-12-31", subtasks:[{id:"g2s1",label:"Run a half marathon time trial to establish baseline",done:false},{id:"g2s2",label:"Complete 8 weeks of Runna speed-focused training",done:false},{id:"g2s3",label:"Run a half marathon under 1:35",done:false},{id:"g2s4",label:"Register for an official half marathon race",done:false},{id:"g2s5",label:"Complete race in sub-1:25",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g3", category:"physical", priority:"Medium", title:"Master nutrition — hit calorie & macro targets consistently", specific:"Hit daily calorie targets and macro splits (protein/carb/fat) for at least 5 out of 7 days per week using MyFitPal tracking and meal prepping every Sunday.", measurable:"MyFitPal streak tracked. Protein target: 160g+/day. Weekly Sunday meal prep completed = pass/fail. Weight trending toward 150–155 lbs.", achievable:"Already bought Tupperware, MyFitPal subscription, and a food scale. Meal prep has started. This is about consistency, not starting from zero.", relevant:"Nutrition is 80% of the body composition goal. You can outwork a bad diet for a while — not forever.", timebound:"2026-09-01", subtasks:[{id:"g3s1",label:"Set up MyFitPal goals — calorie target + macro split",done:false},{id:"g3s2",label:"Complete first full week of tracking every meal",done:false},{id:"g3s3",label:"Maintain 30-day MyFitPal streak",done:false},{id:"g3s4",label:"Meal prep every Sunday for 8 consecutive weeks",done:false},{id:"g3s5",label:"Hit protein target (160g+) for 30 consecutive days",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g4", category:"career", priority:"High", title:"Land a stimulating LDP rotation in Decision Science or Data Engineering", specific:"Secure a rotation placement in Decision Science, Data Engineering, or technical Business Insights by June 8th — via active networking, 3+ informational interviews, and 2+ formal rotation interviews.", measurable:"Track: networking 1:1s completed, interviews scheduled, placement confirmed by July 2026.", achievable:"Already submitted rotate decision. Patrick Graziosi and EDDA leaders are warm contacts. Real project work (Jenkins pipeline, Streamlit app, Terraform IaC) to showcase.", relevant:"You're wasting your early 20s on maintenance work. End-to-end ownership and tangible products are what fill you up.", timebound:"2026-06-08", subtasks:[{id:"g4s1",label:"Complete 1:1s with Decision Science contacts (Scott Cunningham, Jake's team)",done:false},{id:"g4s2",label:"Complete 1:1s with Data Engineering contacts (Trevor Stuart, Joe's teams)",done:false},{id:"g4s3",label:"Prep 5-min project portfolio walkthrough",done:false},{id:"g4s4",label:"Apply to 2–3 internal rotation postings",done:false},{id:"g4s5",label:"Complete at least 2 rotation interviews",done:false},{id:"g4s6",label:"Confirm placement by July 2026",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g5", category:"career", priority:"Medium", title:"Get certified and launch a personal training side gig", specific:"Obtain a recognized personal training certification (CrossFit L1, NASM, or ACE), charge at least 2 paying clients, and define a clear niche.", measurable:"Certification = pass/fail. 2 paying clients minimum. $200+/month revenue within 3 months of launching.", achievable:"Already training a friend for free. Elite athletic credentials (Half Ironman, sub-3hr marathon). Knowledge is there — this is about formalizing and pricing it.", relevant:"You've never wanted a 9–5. Helping people reach their goals lights you up. This is step one toward owning a business.", timebound:"2026-12-31", subtasks:[{id:"g5s1",label:"Research CrossFit L1 vs NASM CPT vs ACE — pick one",done:false},{id:"g5s2",label:"Register and schedule certification",done:false},{id:"g5s3",label:"Pass certification",done:false},{id:"g5s4",label:"Define niche and ideal client",done:false},{id:"g5s5",label:"Set your rates — research local PT pricing",done:false},{id:"g5s6",label:"Convert current free client to paid",done:false},{id:"g5s7",label:"Acquire 1 additional paying client",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g6", category:"career", priority:"Medium", title:"Learn to charge for my skills and think like an entrepreneur", specific:"Stop giving away fitness plans, Excel builds, and technical help for free. Set rates for 3 services. Complete at least one paid transaction for a previously-free service.", measurable:"Rate card for 3 services defined. 1 paid transaction completed by end of 2026.", achievable:"You already build the product. The gap is pricing and the ask — a mindset shift, not a skill gap.", relevant:"You want a business with people working under you. That starts with knowing your worth.", timebound:"2026-12-31", subtasks:[{id:"g6s1",label:"List 3 services you currently give away free",done:false},{id:"g6s2",label:"Research market rates for each",done:false},{id:"g6s3",label:"Write a one-page rate card",done:false},{id:"g6s4",label:"Say your rate out loud in a real conversation",done:false},{id:"g6s5",label:"Complete one paid transaction",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g7", category:"financial", priority:"High", title:"Understand and execute a 401k strategy for buying an investment property", specific:"Document your friend's 401k home-buying strategy, understand loan vs. withdrawal mechanics, and create a written 12-month savings and execution plan for an investment property.", measurable:"1 in-depth conversation documented. Written plan created. Know exact 401k balance and 12-month projection.", achievable:"Already bought a house before, saved $50k from scratch. You're a minimalist who executes on savings plans.", relevant:"You want passive income and financial independence — not just a paycheck. Real estate is the vehicle.", timebound:"2027-03-01", subtasks:[{id:"g7s1",label:"Schedule 1:1 with older friend about his 401k strategy",done:false},{id:"g7s2",label:"Research 401k loan vs. hardship withdrawal rules",done:false},{id:"g7s3",label:"Log into 401k portal — note balance and contribution rate",done:false},{id:"g7s4",label:"Decide: Roth vs Traditional 401k going forward",done:false},{id:"g7s5",label:"Set monthly savings target for down payment",done:false},{id:"g7s6",label:"Create written 12-month investment property plan",done:false},{id:"g7s7",label:"Connect with a real estate investor or HUD counselor",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g8", category:"financial", priority:"Medium", title:"Build a monthly budget and eliminate financial blind spots", specific:"Create a zero-based monthly budget, identify all recurring subscriptions and expenses, and establish a clear savings rate with automatic transfers.", measurable:"Budget created and followed for 3 consecutive months. All subscriptions audited. Savings rate defined as % of take-home pay.", achievable:"You're already minimalist by nature. You saved $50k before — you just need a system, not a lifestyle change.", relevant:"Financial intelligence is the foundation of the investment property goal. You can't invest what you don't track.", timebound:"2026-06-30", subtasks:[{id:"g8s1",label:"List every monthly expense and subscription",done:false},{id:"g8s2",label:"Cancel unused subscriptions",done:false},{id:"g8s3",label:"Build a zero-based monthly budget",done:false},{id:"g8s4",label:"Set up automatic savings transfer",done:false},{id:"g8s5",label:"Follow the budget for 3 consecutive months",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g9", category:"religious", priority:"Medium", title:"Study the major world religions and establish a personal faith practice", specific:"Spend 6 months learning about Catholicism, Protestant Christianity, and 1–2 other faiths. Establish a weekly worship practice by end of 2026.", measurable:"Complete 3+ structured resources. Maintain weekly practice for 8+ consecutive weeks.", achievable:"Grew up Catholic but with a language barrier. English-language resources (The Bible Project on YouTube) are free.", relevant:"You've overcome too much to chalk it up to coincidence. Build a real relationship with God, not just inherited religion.", timebound:"2026-12-31", subtasks:[{id:"g9s1",label:"Watch The Bible Project intro series on YouTube",done:false},{id:"g9s2",label:"Read or listen to the Gospel of Matthew in English",done:false},{id:"g9s3",label:"Attend 2 different church services",done:false},{id:"g9s4",label:"Research one non-Christian faith",done:false},{id:"g9s5",label:'Journal: What do I believe? What resonates?',done:false},{id:"g9s6",label:"Establish a weekly worship/prayer habit",done:false},{id:"g9s7",label:"Maintain the habit for 8 consecutive weeks",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g10", category:"lifestyle", priority:"Medium", title:"Build a consistent male grooming and style routine", specific:"Build a daily skincare routine, establish a consistent haircare routine, and curate 10 versatile outfits across office, social, and active contexts.", measurable:"Skincare streak: 60+ consecutive days. 10 complete outfits catalogued. Own 1–2 signature scents.", achievable:"Already wearing dress pants to the office and bought dress shoes. Building on existing momentum.", relevant:"People treat you how you look. Your presentation should match your ambition.", timebound:"2026-09-01", subtasks:[{id:"g10s1",label:"Research and build a 3-step skincare routine",done:false},{id:"g10s2",label:"Visit a barber and establish a haircut schedule",done:false},{id:"g10s3",label:"Find a signature fragrance",done:false},{id:"g10s4",label:"Audit wardrobe — donate what doesn't fit the vision",done:false},{id:"g10s5",label:"Build 5 office-ready outfits",done:false},{id:"g10s6",label:"Build 5 social outfits",done:false},{id:"g10s7",label:"Maintain daily skincare for 60 consecutive days",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g11", category:"emotional", priority:"High", title:"Develop emotional regulation skills and reduce reactive behavior", specific:"Work in therapy to identify 3 core emotional triggers, develop 2–3 healthy coping strategies, and reduce reactive outbursts — especially toward Sebastian.", measurable:"Therapy 2x/month minimum. Journal 3x/week. Reactive episodes reduced by 50% over 6 months.", achievable:"Already in therapy. Already self-aware enough to name the patterns. Now it's about tools and consistency.", relevant:"You go go go without stopping to feel. This is the foundation everything else rests on.", timebound:"2026-12-31", subtasks:[{id:"g11s1",label:"Attend therapy consistently — minimum 2x/month",done:false},{id:"g11s2",label:"Start a 3x/week feelings journal",done:false},{id:"g11s3",label:"Identify and write down 3 core emotional triggers",done:false},{id:"g11s4",label:"Learn and practice 1 regulation technique with therapist",done:false},{id:"g11s5",label:"Track reactive moments toward Sebastian for 30 days",done:false},{id:"g11s6",label:"Share the parenting goal with your therapist explicitly",done:false},{id:"g11s7",label:"Review progress at month 3 and month 6",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g12", category:"parenting", priority:"High", title:"Create a consistent, connected parenting rhythm with Sebastian", specific:"Establish a weekly phone-free 1:1 activity with Sebastian. Replace phone-as-babysitter with 3 go-to activities. Take Sebastian on at least 2 trips this year.", measurable:"Weekly 1:1 tracked. 2 trips completed. No yelling for 7 consecutive days = first milestone.", achievable:"You already take him to the gym and salsa. The love is there. This is about structure and self-regulation.", relevant:"Sebastian is the most important relationship in your life. Breaking the cycle is the most meaningful thing you can do.", timebound:"2026-12-31", subtasks:[{id:"g12s1",label:"Complete Florida trip April 7–14 with Sebastian ✈️",done:false},{id:"g12s2",label:"Establish 1 weekly phone-free activity with Sebastian",done:false},{id:"g12s3",label:"Identify 3 go-to non-phone activities Sebastian loves",done:false},{id:"g12s4",label:"Go 7 consecutive days without yelling",done:false},{id:"g12s5",label:"Discuss parenting triggers in therapy",done:false},{id:"g12s6",label:"Plan and complete a second trip with Sebastian",done:false},{id:"g12s7",label:"Ask Sebastian what his favorite things to do with you are",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g13", category:"travel", priority:"Medium", title:"Complete a Las Vegas to Southwest National Parks road trip", specific:"Fly to Las Vegas, rent a car, road trip through 3+ national parks (Zion, Bryce Canyon, Grand Canyon, Joshua Tree) with one athletic challenge at each park.", measurable:"3+ national parks visited. 1 athletic activity per park. Trip planned 6 weeks in advance.", achievable:"Already solo traveled to Puerto Rico and Miami. Comfortable with independent travel and hard physical challenges.", relevant:"You want to see what the US has to offer. Solo travel shapes you. This is the road trip version — epic and formative.", timebound:"2026-11-30", subtasks:[{id:"g13s1",label:"Pick a travel window (fall 2026 — best Southwest weather)",done:false},{id:"g13s2",label:"Research Zion, Bryce Canyon, Grand Canyon, Joshua Tree",done:false},{id:"g13s3",label:"Book flights to Las Vegas",done:false},{id:"g13s4",label:"Book rental car",done:false},{id:"g13s5",label:"Book accommodations (campsite or budget lodging)",done:false},{id:"g13s6",label:"Plan 1 athletic activity per park",done:false},{id:"g13s7",label:"Complete the trip 🏜️",done:false}], journal:[], createdAt:"2026-03-06" },
  { id:"g14", category:"travel", priority:"Low", title:"Plan a California and West Coast exploration trip", specific:"Take a West Coast trip covering California (LA, SF, or both) plus one additional coastal or nature destination — incorporating an athletic component like a coastal run, bike ride, or hike.", measurable:"Trip planned and booked. At least 2 distinct destinations visited. 1 athletic challenge completed.", achievable:"Comfortable solo traveler. Domestic trip — no passport required. Budget-conscious traveler who plans well.", relevant:"You've explored the Northeast. The West Coast is a completely different world. This broadens who you are.", timebound:"2027-06-30", subtasks:[{id:"g14s1",label:"Decide: LA, SF, both, or Pacific Coast Highway road trip",done:false},{id:"g14s2",label:"Research top athletic/outdoor experiences on West Coast",done:false},{id:"g14s3",label:"Book flights",done:false},{id:"g14s4",label:"Book accommodations",done:false},{id:"g14s5",label:"Complete the trip 🌊",done:false}], journal:[], createdAt:"2026-03-06" },
];
...
const calcProgress = g => {
  const t = g.subtasks.length, d = g.subtasks.filter(s => s.done).length;
...
function AICoachModal({ onClose, onGoalGenerated }) {
  ...
  const SYSTEM = `You are a SMART Goal Coach inside a personal goal tracking app.
Help the user define a SMART goal through natural conversation.
Categories: physical, financial, religious, parenting, career, lifestyle, emotional, travel.
When ready output: <GOAL_JSON>{ "title": "...", "category": "physical", "priority": "High", "specific": "...", "measurable": "...", "achievable": "...", "relevant": "...", "timebound": "YYYY-MM-DD", "subtasks": ["..."] }</GOAL_JSON>
User context: ambitious early-20s data engineer at Travelers Insurance LDP, single father to Sebastian, Half Ironman + sub-3hr marathon athlete, wants personal training business, working toward investment property.
  ...
  const send = async () => {
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({ model: "claude-sonnet-4-20250514", max_tokens: 1000, system: SYSTEM, messages: nm.map(m => ({ role: m.role, content: m.content })) })
      });
      ...
      if (match) {
        try {
          ...
          setPending({ id: Date.now().toString(), ...raw, category: raw.category?.toLowerCase() || "physical", subtasks: (raw.subtasks || []).map((s, i) => ({ id: `ai${Date.now()}${i}`, label: s, done: false })), journal: [], createdAt: todayStr() });
        } catch (e) {}
      }
      ...
      <div style={{ background: "#0D0F14", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 22, width: "min(580px,96vw)", height: "min(680px,90vh)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ padding: "18px 22px", borderBottom: `1px solid ${T.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", background: "rgba(155,143,232,0.05)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 9, color: "rgba(155,143,232,0.7)", letterSpacing: 2 }}>POWERED BY CLAUDE AI</div>
            </div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "18px 22px", display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {loading && (
            <div style={{ display: "flex" }}>
              <div style={{ padding: "12px 16px", borderRadius: "16px 16px 16px 4px", background: "rgba(255,255,255,0.05)", border: `1px solid ${T.border}`, display: "flex", gap: 5, alignItems: "center" }}>
                {[0, 1, 2].map(i => <div key={i} style={{ width: 6, height: 6, borderRadius: "50%", background: "rgba(155,143,232,0.8)", animation: "blink 1.2s ease-in-out infinite", animationDelay: `${i * 0.2}s` }} />)}
              </div>
            </div>
          )}
          {pending && cat && (
        ...
        <div style={{ padding: "14px 22px", borderTop: `1px solid ${T.border}`, display: "flex", gap: 10 }}>
          ...
          <button onClick={send} disabled={loading || !input.trim()}
            style={{ background: input.trim() ? "linear-gradient(135deg,#9B8FE8,#7EB8D4)" : "rgba(255,255,255,0.06)", border: "none", borderRadius: 12, padding: "0 20px", color: input.trim() ? "#fff" : "rgba(255,255,255,0.2)", cursor: input.trim() ? "pointer" : "not-allowed", fontWeight: 700, fontSize: 13, fontFamily: "inherit" }}>Send</button>
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.88)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, backdropFilter: "blur(8px)" }}>
      <div style={{ background: "#13151E", border: `1px solid ${T.border}`, borderRadius: 20, width: "min(540px,95vw)", padding: "36px", position: "relative" }}>
        <div style={{ display: "flex", gap: 4, marginBottom: 28 }}>
          {steps.map((_, i) => <div key={i} style={{ flex: 1, height: 3, borderRadius: 2, background: i <= step ? cat.color : "rgba(255,255,255,0.1)", transition: "background 0.3s" }} />)}
        </div>
        ...
        {cur.hint && <p style={{ fontSize: 12, color: T.muted, margin: "0 0 16px" }}>{cur.hint}</p>}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 9 }}>
            {CATS.map(c => (
              <button key={c.id} onClick={() => upd("category", c.id)}
                style={{ background: form.category === c.id ? `${c.color}22` : "rgba(255,255,255,0.03)", border: `1.5px solid ${form.category === c.id ? c.color : T.faint}`, borderRadius: 11, padding: "12px 6px", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: 5, fontFamily: "inherit" }}>
                <span style={{ fontSize: 20 }}>{c.icon}</span>
                <span style={{ fontSize: 10, color: form.category === c.id ? c.color : T.muted, fontWeight: 700 }}>{c.label}</span>
              </button>
            ))}
          </div>
        )}
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {["High", "Medium", "Low"].map(p => (
              <button key={p} onClick={() => upd("priority", p)}
                style={{ flex: 1, padding: "13px", borderRadius: 11, border: `1.5px solid ${form.priority === p ? (p === "High" ? "#E8645A" : p === "Medium" ? "#C8A96E" : "#4CAF82") : T.faint}`, background: form.priority === p ? "rgba(255,255,255,0.06)" : "transparent", color: form.priority === p ? "#fff" : T.muted, cursor: "pointer", fontWeight: 700, fontSize: 13, fontFamily: "inherit" }}>{p}</button>
            ))}
          </div>
        )}
        {cur.type === "subtasks" && (
          <div>
            <div style={{ display: "flex", gap: 8, marginBottom: 10 }}>
              <input value={si} onChange={e => setSi(e.target.value)} onKeyDown={e => e.key === "Enter" && addSub()} placeholder="Add a milestone..." style={{ ...inp, flex: 1 }} />
              <button onClick={addSub} style={{ background: cat.color, border: "none", borderRadius: 10, padding: "0 16px", color: "#fff", cursor: "pointer", fontWeight: 700, fontSize: 17, fontFamily: "inherit" }}>+</button>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 7, maxHeight: 170, overflowY: "auto" }}>
              {form.subtasks.map(s => (
                <div key={s.id} style={{ display: "flex", alignItems: "center", gap: 9, background: "rgba(255,255,255,0.04)", borderRadius: 8, padding: "9px 13px" }}>
                  <span style={{ flex: 1, color: "rgba(255,255,255,0.8)", fontSize: 13 }}>{s.label}</span>
                  <button onClick={() => upd("subtasks", form.subtasks.filter(x => x.id !== s.id))} style={{ background: "none", border: "none", color: T.muted, cursor: "pointer", fontSize: 15, fontFamily: "inherit" }}>✕</button>
                </div>
              ))}
              {form.subtasks.length === 0 && <p style={{ color: "rgba(255,255,255,0.2)", fontSize: 12, textAlign: "center", padding: "14px 0" }}>No subtasks yet</p>}
            </div>
          </div>
        )}
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 28 }}>
          ...
          {step < steps.length - 1
            ? <button onClick={() => setStep(s => s + 1)} disabled={!canNext()} style={{ background: canNext() ? cat.color : "rgba(255,255,255,0.08)", border: "none", borderRadius: 10, padding: "11px 26px", color: canNext() ? "#fff" : "rgba(255,255,255,0.2)", cursor: canNext() ? "pointer" : "not-allowed", fontWeight: 700, fontSize: 13, fontFamily: "inherit" }}>Continue →</button>
            : <button onClick={save} style={{ background: cat.color, border: "none", borderRadius: 10, padding: "11px 26px", color: "#fff", cursor: "pointer", fontWeight: 700, fontSize: 13, fontFamily: "inherit" }}>{editGoal ? "Save ✓" : "Create Goal ✓"}</button>
          }
        </div>
      </div>
    </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 9, maxHeight: 170, overflowY: "auto", marginTop: 11 }}>
        {[...goal.journal].reverse().map((j, i) => (
          <div key={i} style={{ background: "rgba(255,255,255,0.03)", borderRadius: 8, padding: "10px 13px", borderLeft: `3px solid ${catColor}` }}>
            <div style={{ fontSize: 10, color: T.muted, marginBottom: 4 }}>{j.date}</div>
        ...
        <div style={{ padding: "0 21px 21px", borderTop: `1px solid ${T.border}` }}>
          ...
          <div style={{ marginTop: 13 }}>
            ...
            <div style={{ height: 3, borderRadius: 2, background: "rgba(255,255,255,0.07)" }}>
              <div style={{ height: "100%", borderRadius: 2, background: cat.color, width: `${pct}%`, transition: "width 0.6s ease" }} />
            </div>
          </div>
...
// ─── GOALS PAGE ──────────────────────────────────────────────────────────────
function GoalsPage({ goals, setGoals, setShowAI, setShowModal, setEditGoal }) {
  ...
  const completed = goals.filter(g => { const t = g.subtasks.length, d = g.subtasks.filter(s => s.done).length; return t > 0 && d === t; }).length;
  ...
  const toggleSubtask = (gid, sid) => setGoals(gs => gs.map(g => g.id !== gid ? g : { ...g, subtasks: g.subtasks.map(s => s.id !== sid ? s : { ...s, done: !s.done }) }));
  const deleteGoal = id => setGoals(gs => gs.filter(g => g.id !== id));
  const addNote = (gid, entry) => setGoals(gs => gs.map(g => g.id !== gid ? g : { ...g, journal: [...g.journal, entry] }));

  return (
    <div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 11, marginBottom: 20 }}>
        {[
          { l: "Total Goals",   v: total,         s: "across all areas",   c: "#9B8FE8" },
          { l: "Completed",     v: completed,     s: "all subtasks done",  c: "#4CAF82" },
          { l: "Progress",      v: `${overall}%`, s: "average completion", c: "#7EB8D4" },
          { l: "High Priority", v: highActive,    s: "still in progress",  c: "#E8645A" },
        ].map(x => (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 9, marginBottom: 20 }}>
        {CATS.map(c => {
          const cg = goals.filter(g => g.category === c.id);
          if (!cg.length) return null;
          const avg = Math.round(cg.reduce((a, g) => a + calcProgress(g), 0) / cg.length);
          return (
            <div key={c.id} onClick={() => setActiveCat(ac => ac === c.id ? "all" : c.id)}
              style={{ background: activeCat === c.id ? `${c.color}12` : T.card, border: `1px solid ${activeCat === c.id ? c.color + "55" : T.border}`, borderRadius: 11, padding: "12px 13px", cursor: "pointer", transition: "all 0.2s" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                <span style={{ fontSize: 14 }}>{c.icon}</span>
                <span style={{ fontSize: 11, fontWeight: 700, color: c.color }}>{avg}%</span>
              </div>
              <div style={{ fontSize: 11, fontWeight: 600, color: "rgba(255,255,255,0.62)", marginBottom: 5 }}>{c.label}</div>
              <div style={{ height: 3, borderRadius: 2, background: "rgba(255,255,255,0.06)" }}>
                <div style={{ height: "100%", borderRadius: 2, background: c.color, width: `${avg}%`, transition: "width 0.6s" }} />
              </div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 13, flexWrap: "wrap" }}>
        ...
        {["all", "High", "Medium", "Low"].map(p => (
          <button key={p} onClick={() => setActivePri(p)}
            style={{ padding: "9px 14px", borderRadius: 10, border: `1px solid ${activePri === p ? "rgba(255,255,255,0.3)" : T.border}`, background: activePri === p ? "rgba(255,255,255,0.08)" : "transparent", color: activePri === p ? "#fff" : T.muted, cursor: "pointer", fontSize: 11, fontWeight: 600, fontFamily: "inherit" }}>
            {p === "all" ? "All" : p}
          </button>
        ))}
      </div>
      ...
      {filtered.length === 0
        ? (<div style={{ textAlign: "center", padding: "60px 0" }}>
            ...
            <h3 style={{ color: T.muted, fontWeight: 400, fontSize: 14, margin: "0 0 6px" }}>No goals match</h3>
            <p style={{ color: "rgba(255,255,255,0.14)", fontSize: 12, margin: 0 }}>Try "All" or use the AI Coach</p>
          </div>)
        : filtered.map(g => <GoalCard key={g.id} goal={g} onToggleSubtask={toggleSubtask} onDelete={deleteGoal} onEdit={eg => { setEditGoal(eg); setShowModal(true); }} onAddNote={addNote} />)
      }
    </div>
  );
}
...
function HabitsPage({ habits, setHabits, habitLogs, setHabitLogs }) {
  ...
  const toggle = (hid) => { setHabitLogs(logs => ({ ...logs, [today]: { ...todayLog, [hid]: !todayLog[hid] } })); };
  ...
  const addHabit = () => {
    ...
    setHabits(hs => [...hs, { id: `h${Date.now()}`, category: newHabit.category, label: newHabit.label.trim(), icon: newHabit.icon, color: newHabit.color }]);
    ...
    <div>
      <div style={{ background: T.card, borderRadius: 16, padding: "20px 24px", marginBottom: 18, border: `1px solid ${T.border}`, display: "flex", alignItems: "center", gap: 20 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 700, color: "#fff", marginBottom: 4 }}>{allDone ? "🎉 All done!" : `${doneCnt} of ${filtered.length} habits`}</div>
              ...
              {catHabits.map(h => {
                ...
                return (
                  <div key={h.id} style={{ background: done ? `${h.color}10` : T.card, border: `1px solid ${done ? h.color + "44" : T.border}`, borderRadius: 12, padding: "13px 16px", display: "flex", alignItems: "center", gap: 13, transition: "all 0.2s", cursor: "pointer" }} onClick={() => toggle(h.id)}>
                    ...
                    <button onClick={e => { e.stopPropagation(); deleteHabit(h.id); }} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.15)", cursor: "pointer", fontSize: 13, padding: "2px 4px", fontFamily: "inherit" }}>✕</button>
                  </div>
                );
              })}
            </div>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                {HAB_CATS.map(c => (
                  <button key={c.id} onClick={() => setNewHabit(n => ({ ...n, category: c.id, color: c.color }))}
                    style={{ padding: "7px 14px", borderRadius: 8, border: `1.5px solid ${newHabit.category === c.id ? c.color : T.faint}`, background: newHabit.category === c.id ? `${c.color}20` : "transparent", color: newHabit.category === c.id ? c.color : T.muted, cursor: "pointer", fontSize: 12, fontWeight: 600, fontFamily: "inherit" }}>
                    {c.icon} {c.label}
                  </button>
                ))}
              </div>
...
function AnalyticsPage({ habits, habitLogs, goals }) {
  ...
  const catStats = HAB_CATS.map(cat => {
    ...
    const avg = ch.length > 0 && dates.length > 0 ? Math.round(ch.reduce((a, h) => { const done = dates.filter(d => habitLogs[d]?.[h.id]).length; return a + done / dates.length * 100; }, 0) / ch.length) : 0;
...
Overall avg daily completion: ${Math.round(dailyData.reduce((a, d) => a + d.pct, 0) / Math.max(dailyData.length, 1))}%
    ...
    <div>
        ...
        <div style={{ display: "flex", gap: 7 }}>
          {[["week", "7 Days"], ["month", "30 Days"], ["quarter", "90 Days"], ["halfyear", "6 Months"], ["year", "1 Year"]].map(([k, l]) => (
            <button key={k} onClick={() => setPeriod(k)}
              style={{ padding: "8px 14px", borderRadius: 9, border: `1px solid ${period === k ? "rgba(255,255,255,0.35)" : T.border}`, background: period === k ? "rgba(255,255,255,0.1)" : "transparent", color: period === k ? "#fff" : T.muted, cursor: "pointer", fontSize: 11, fontWeight: 600, fontFamily: "inherit" }}>{l}</button>
          ))}
        </div>
      ...
      {(aiInsight || aiLoading) && (
        <div style={{ background: "linear-gradient(135deg,rgba(155,143,232,0.1),rgba(232,122,175,0.08))", border: "1px solid rgba(155,143,232,0.3)", borderRadius: 14, padding: "20px 22px", marginBottom: 18 }}>
          ...
          {aiLoading
            ? <div style={{ display: "flex", gap: 5, alignItems: "center" }}>{[0, 1, 2].map(i => <div key={i} style={{ width: 7, height: 7, borderRadius: "50%", background: "rgba(155,143,232,0.8)", animation: "blink 1.2s ease-in-out infinite", animationDelay: `${i * 0.2}s` }} />)}</div>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", gap: period === "year" ? 1 : period === "halfyear" ? 2 : period === "quarter" ? 3 : 4, height: 80, overflow: "hidden" }}>
          {dailyData.map((d, i) => (
            <div key={i} title={`${d.date}: ${d.pct}%`}
              style={{ flex: 1, minWidth: 0, background: d.pct === 100 ? "#4CAF82" : d.pct > 70 ? "#9B8FE8" : d.pct > 40 ? "#C8A96E" : "rgba(255,255,255,0.1)", borderRadius: "2px 2px 0 0", height: `${Math.max((d.pct / maxBar) * 100, d.pct > 0 ? 8 : 2)}%`, transition: "height 0.3s", cursor: "pointer" }} />
          ))}
        </div>
      ...
      <div style={{ background: T.card, borderRadius: 14, padding: "18px 20px", marginBottom: 18, border: `1px solid ${T.border}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          ...
          <select value={filterHabit} onChange={e => setFilterHabit(e.target.value)}
            style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 8, padding: "5px 10px", color: T.muted, fontSize: 11, outline: "none", fontFamily: "inherit" }}>
...
Category must be one of: morning, night, fitness, nutrition. Color should match: morning=#C8A96E, night=#9B8FE8, fitness=#E8645A, nutrition=#4CAF82. Keep labels concise (under 40 chars).`;
      try {
        const res = await fetch("https://api.anthropic.com/v1/messages", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleAdd = () => {
    const toAdd = suggestions.filter(s => selected[s.id]).map(s => ({ id: `h_${Date.now()}_${Math.random().toString(36).slice(2)}`, label: s.label, category: s.category, icon: s.icon, color: s.color }));
    onAdd(toAdd); onClose();
  };
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.88)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1100, backdropFilter: "blur(12px)" }}>
      <div style={{ background: "#13151E", border: `1px solid ${cat.color}44`, borderRadius: 22, width: "min(500px,95vw)", padding: "32px", position: "relative" }}>
              ...
              return (
                <div key={s.id} onClick={() => toggleSel(s.id)}
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 10, color: s.color, marginTop: 1, textTransform: "capitalize" }}>{HAB_CATS.find(c => c.id === s.category)?.label || s.category}</div>
                  </div>
                </div>
              );
            })}
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={onClose} style={{ flex: 1, background: "none", border: `1px solid ${T.faint}`, borderRadius: 11, padding: "12px", color: T.muted, cursor: "pointer", fontSize: 13, fontFamily: "inherit" }}>Skip</button>
          {!loading && !error && (
...
export default function App() {
  ...
  const [goals, setGoals] = useLS("jd-goals-v3", SEED_GOALS);
  const [habits, setHabits] = useLS("jd-habits-v1", SEED_HABITS);
  const [habitLogs, setHabitLogs] = useLS("jd-habit-logs-v1", {});
    ...
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'DM Sans',system-ui,sans-serif", color: T.text }}>
      <div style={{ borderBottom: `1px solid ${T.border}`, padding: "14px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, background: "rgba(7,8,12,0.97)", backdropFilter: "blur(20px)", zIndex: 10, gap: 16, flexWrap: "wrap" }}>
        <div style={{ flexShrink: 0 }}>
          <div style={{ fontSize: 10, color: T.muted, letterSpacing: 3, textTransform: "uppercase", marginBottom: 1 }}>{greet()}, Juan</div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "22px 18px" }}>
        {tab === "goals"     && <GoalsPage goals={goals} setGoals={setGoals} setShowAI={setShowAI} setShowModal={setShowModal} setEditGoal={setEditGoal} />}
        {tab === "habits"    && <HabitsPage habits={habits} setHabits={setHabits} habitLogs={habitLogs} setHabitLogs={setHabitLogs} />}
      ...
      {suggestFor && <HabitSuggester goal={suggestFor} existingHabits={habits}
        onAdd={newHabits => setHabits(hs => [...hs, ...newHabits])}
